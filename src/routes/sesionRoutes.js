...
router.post('/formularioPago', verificarAutenticacion, (req, res) => {
...
import { crearSeguimientosPendientesClientesModels } from '../models/clientesModels.js'
